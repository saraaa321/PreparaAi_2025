  ...
  return (
    <div className="SobreNos">
      ...
      <main className="main-content">
        <img src="sobren.png" alt="Sobre Nós" className="sobrenos" />
        <p className="p">
        ...
        <img src="devs.png" alt="Desenvolvedores" className="devsIMG" />

        <div className="devs-container">
          <div className="devs">
            <img src="polyteste.png" alt="Polyana" className="devs-imgA" />
          ...
          <div className="devs">
            <img src="sara.png" alt="Sara" className="devs-img" />
          ...
          <div className="devs">
            <img src="giovana2.png" alt="Giovana" className="devs-img" />
        ...
        <br></br>
          ...
          <div className="devs">
            <img src="edu.png" alt="Eduardo" className="devs-img" />
          ...
          <div className="devs">
            <img src="joao.png" alt="Joao" className="devs-img" />
          ...
          <div className="devs">
            <img src="ariel.png" alt="Ariel" className="devs-img" />
          ...
          <div className="devs">
            <img src="duda.png" alt="Duda" className="devs-img" />
